...
-   **Heart Disease Prediction (`models/heart_model.py`):** Features a Random Forest classifier predicting risk across three types: Generic Cardiovascular Disease, Coronary Artery Disease, and Cardiac Arrhythmia, based on 14 medical features. Includes smart form reset functionality.
